...
public class Test2 extends OpenWebsite {

    @Before
    public void setFilterByType () throws InterruptedException {
        driver.findElementByXPath("//*[@id='__ozon']/div/div[1]/div[3]/div[2]/div[1]/aside/div[9]/div[2]/div/span[1]").click();


        driver.findElementByXPath(".//*[contains(text(), 'Рожковая')]").click();
